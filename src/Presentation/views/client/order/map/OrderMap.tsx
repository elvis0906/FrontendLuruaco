...
export const ClientOrderMapScreen = ({navigation, route} : Props) => {
  ...
  const {messagePermissions, position, socket, responseMessage, mapRef, origin, destination} = useViewModel(order)
        ...
        <MapView 
          ...
          <View style={styles.infoClient}>
              <Image
                ...
                <Text style={styles.nameClient}>{order.delivery?.firstName} {order.delivery?.lastName}</Text>
                <Image
